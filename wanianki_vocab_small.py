...
vocabulary_model = genanki.Model(vocabulary_model_id, 'Vocabulary Model',
    ...
    css=".card { text-align:center; color: #ffffff; background: #a100f1; margin: 0px auto; }"
        ".style-front { text-align:center; font-size: 80px; color: #ffffff; background: #a100f1; margin-top: 15px; }"
        ".style-meaning { text-align:center; font-size: 30px; color: #ffffff; background: #a100f1; margin: 0px; }"
        ".style-level { font-size: 10px; font-weight: bold; position: absolute; top: 0; right: 0; }"
        ".style-reading { text-align:center; font-size: 40px; color: #ffffff; background: #a100f1; margin-top: 10px; margin-bottom: 15px; } "
        ".line-dash { margin-top: 15px; margin-bottom: 20px;  border-top: #ffffff dashed 2px; }")
